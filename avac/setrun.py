...
#------------------------------
    ...
    # amr region specification
    regions.append([1, AddSetrun.refinement, 0., AddSetrun.tmax, AddSetrun.amrxmin,AddSetrun.amrxmax, AddSetrun.amrymin,AddSetrun.amrymax])
